...
namespace srag\ActiveRecordConfig\SrDsgvo;
...
use srag\ActiveRecordConfig\SrDsgvo\Exception\ActiveRecordConfigException;
use srag\DIC\SrDsgvo\DICTrait;

/**
 * Class ActiveRecordConfig
 *
 * @package srag\ActiveRecordConfig\SrDsgvo
 *
